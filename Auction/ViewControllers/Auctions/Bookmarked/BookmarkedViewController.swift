...
class BookmarkedViewController: UIViewController, BookmarkedViewProtocol {

    @IBOutlet weak var tableView: UITableView!
    @IBOutlet var emptyLabel: UILabel!
    
    var presenter: BookmarkedPresenterProtocol?
    ...
    func setCurrencyRate(data: Data) {
        ...
        self.presenter?.interactor?.getBookmarkedLots()
    }
...
extension BookmarkedViewController: CellButtonDelegate {
...
extension BookmarkedViewController: BiggerCellButtonDelegate {
...
extension BookmarkedViewController: UITextFieldDelegate {
